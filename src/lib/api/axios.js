...
export const login = async (body) => {
   console.log("variables.privatePath", variables.privatePath);
   console.log("variables.privatePath import", import.meta.env.VITE_PUBLIC_BASE_PATH);
   try {
...
export const setNotificationViewed = async (id) => {
   let integerID = +id;
   try {
      let response = await privatePath.post("/setNotificationViewed", {
         notificationId: integerID,
      });
      return response.data;
   } catch (error) {
      console.error(error);
